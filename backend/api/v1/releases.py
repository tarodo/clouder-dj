...
from backend.core.errors import LABEL_NOT_FOUND, RELEASE_ALREADY_EXISTS, RELEASE_NOT_FOUND
...
router = create_crud_router(
    ...
    create_error_codes=[RELEASE_ALREADY_EXISTS, LABEL_NOT_FOUND],
    update_error_codes=[RELEASE_ALREADY_EXISTS, RELEASE_NOT_FOUND, LABEL_NOT_FOUND],
