...
class SpotifyAPIClient:
    ...
    async def exchange_code_for_token(self, code: str) -> dict:
        ...
        token_data = {
            ...
            # client_id and client_secret are passed via auth
        }
...
class UserSpotifyClient:
    def __init__(
        ...
        *,
        ...
        token_repo: IntegrationRepository,
        token_obj: UserIntegration,
        spotify_user_id: str,
    ):
        self.client = client
        ...
        self.access_token = decrypt_token(token_obj.access_token)
        self.refresh_token = decrypt_token(token_obj.refresh_token)
    ...
    async def _refresh_access_token(self) -> None:
        ...
        try:
            ...
            if (
                ...
                await self.token_repo.delete(db_obj=self.token_obj)
        ...
        new_expires_at = (datetime.now(timezone.utc) + timedelta(seconds=expires_in)).replace(tzinfo=None)
        ...
        if new_refresh_token:
            ...
            await self.token_repo.update_tokens(
                ...
                new_access_token=encrypted_access_token,
